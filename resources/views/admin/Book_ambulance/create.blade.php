    ...
    <div class="content-wrapper">
        ...
        <div class="card shadow">
            <div class="card-header bg-success text-white">
                <h4 class="mb-0">Create Book Ambulance</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('bookambulance.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('drop_location') is-invalid @enderror" 
                            id="drop_location" name="drop_location" value="{{ old('drop_location') }}" required>
                        @error('drop_location')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
