                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('doctor.update', $data->id) }}" method="POST" class="forms-sample"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='phone' value="{{ $data->phone }}" class="form-control"
                                        id="exampleInputEmail3" placeholder="phone ">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputCity1">Email Address</label>
                                    <input type="email" name='email' value="{{ $data->email }}" class="form-control"
                                        id="exampleInputCity1" placeholder="email">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputCity1">Experience</label>
                                    <input type="text" name='experience' value="{{ $data->experience }}"
                                        class="form-control" id="exampleInputCity1" placeholder="experience">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputCity1">Fees</label>
                                    <input type="text" name='fees' value="{{ $data->fees }}" class="form-control"
                                        id="exampleInputCity1" placeholder="fees">
                                </div>
                                <div class="form-group">
                                    <label for="about_us">About Us</label>
                                    <textarea name="about_us" id="about_us" class="form-control" rows="4">{{ old('about_us', $data->about_us) }}</textarea>
                                </div>
                                <div class="form-group">
