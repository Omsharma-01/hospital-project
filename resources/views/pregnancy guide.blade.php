...
<p>your jounery to 
motherhood is special <br> we are here to support you every step of the way 
</p>
<ul class="list-group list-group-flush">
  <li class="list-group-item">Expert care for a healthy pregnancy</li>
  <li class="list-group-item">Regular prenatal checkups</li>
  <li class="list-group-item">Nutritional guidance</li>
  <li class="list-group-item">Emotional support</li>
  <li class="list-group-item">Postpartum care</li>
</ul>
