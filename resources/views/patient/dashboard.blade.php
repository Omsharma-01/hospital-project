...
<style>
    ...
    .stat-card .stat-icon.pink { background: #fce4ec; color: #f64d86; }
    .stat-card .stat-icon.blue { background: #e3f2fd; color: #1976d2; }
    .stat-card .stat-icon.green { background: #e8f5e9; color: #388e3c; }
    ...
    .stat-trend.up { background: #e8f5e9; color: #388e3c; }
    .stat-trend.down { background: #fce4ec; color: #c62828; }
    ...
    .appointment-item .appointment-info { flex: 1; }
    ...
    .activity-icon.pink-bg { background: #fce4ec; color: #f64d86; }
    .activity-icon.blue-bg { background: #e3f2fd; color: #1976d2; }
    .activity-icon.green-bg { background: #e8f5e9; color: #388e3c; }
...
<div class="dashboard-wrapper">
    <div class="dashboard-container">
        ...
        <div class="welcome-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <div class="mt-3">
                        <span class="badge" style="background: rgba(255,255,255,0.2); padding: 8px 16px; border-radius: 50px;">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card">
                    <div class="stat-icon green"><i class="bi bi-ambulance"></i></div>
                    <div class="stat-number">{{ $totalAmbulances ?? 0 }}</div>
                    <div class="stat-label">Ambulance Requests</div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                ...
                <div class="dashboard-card">
                    <div class="card-header">
                        <span><i class="bi bi-calendar3 me-2" style="color: var(--primary);"></i>Recent Appointments</span>
                ...
                <div class="dashboard-card mt-4">
                    <div class="card-header">
                        <span><i class="bi bi-ambulance me-2" style="color: var(--primary);"></i>Ambulance Requests</span>
                    ...
                    <div class="card-body">
                        @forelse($recentAmbulances as $ambulance)
                            <div class="appointment-item">
                                ...
                                <span class="appointment-status status-{{ $ambulance->status }}">{{ ucfirst($ambulance->status) }}</span>
                            </div>
                        @empty
                            <p class="text-muted text-center py-3">No ambulance requests. <a href="{{ route('patient.ambulance') }}">Book one now!</a></p>
                        @endforelse
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                ...
                <div class="dashboard-card">
                    <div class="card-header">
                        <span><i class="bi bi-grid-3x3-gap-fill me-2" style="color: var(--primary);"></i>Quick Actions</span>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-6">
                ...
                <!-- Health Tip -->
                <div class="dashboard-card mt-4" style="background: linear-gradient(135deg, #fce4ec, #fff0f5); border: none;">
                    <div class="card-body">
