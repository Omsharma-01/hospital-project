...
<div class="container">
    ...
    <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6" data-aos="fade-right">
            ...
            <img src="{{ asset('images/pregnancy-banner.png') }}"
                 class="img-fluid"
                 alt="Pregnancy Care">
    ...
    <div class="text-center mt-5" data-aos="zoom-in">
        ...
        <a href="/appointment"
           class="btn btn-danger btn-lg cta-btn me-2">
            <i class="bi bi-calendar-heart-fill"></i>
            Book Appointment
        </a>

        <a href="tel:+917050505083"
           class="btn btn-outline-danger btn-lg cta-btn">
            <i class="bi bi-telephone-fill"></i>
            Emergency Call
        </a>
...
<a href="tel:+917050505083" class="emergency-btn">
